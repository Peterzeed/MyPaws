...
import 'package:mypaws/src/pages/feed/found%20pet/found_pet_feed.dart';
import 'package:mypaws/src/pages/feed/lost%20pet/lost_pet_feed.dart';
...
class NewFeedPage extends GetView<NewFeedPageController> {
  ...
  final NewFeedPageController _newFeedPageController = Get.put(NewFeedPageController());
