...
class LostFeedDetail extends StatelessWidget {
  LostFeedDetail({Key? key}) : super(key: key);

  static const itemArg = "itemArg";

  final _petPost = Get.put(FeedDetailController());
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        _petPost.postDetail.ownername!.substring(0, 1)
                                                  .toUpperCase() + _petPost.postDetail.ownername!.substring(1),
